...
console.log(`The ${tyrannosaurus.name} is from the ${tyrannosaurus.era} period.`);
...
function universitySort() {
  for(let i = 0; i < graduates.length; i++) {
      universities.push(graduates[i].university);
  }
}
universitySort(graduates);
...
for (let i = 0; i < zooAnimals.length; i++) {
  if(zooAnimals[i].population > 5 || zooAnimals[i].population === 5){
